...
{
  my.office.files.bookmarks.enable = true;
  fs-bookmarks.bookmarks =
    ...
    rec {
      ...
      oth = {
        dir = semester.${toString semester_max};
      };
      ...
      uws = {
        dir = "${semester."1"}/Umweltschutz_Einfuehrung";
      };
